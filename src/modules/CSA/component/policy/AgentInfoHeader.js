      ...
      <Fragment>
        {this.props.type === "approver" &&
          <div className="xl-12 flex-container flex-wrap insured-details">
            <Input editable="false" inputLabel="Agent Code:" inputPlaceholder="000000000" txtboxClass="no-border" inputClass="col xl-3 l-3 m-3 s-3 xs-3 no-padding input-container" value={this.props.policy.agentCode} />
            ...
            <Input editable="false" inputLabel="Agent Status:" inputPlaceholder="Active" txtboxClass="no-border" inputClass="col xl-3 l-3 m-3 s-3 xs-3 no-padding input-container" value={this.props.policy.status} />
