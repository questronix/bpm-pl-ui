        ...
        <div className="flex-container flex-wrap">
          <div className="col xl-12">
            <div className="card-alt col xl-12 l-12 m-12 s-12 xs-12 no-padding">
              <div className="card-header xl-12 flex-container flex-wrap">
                <div className="xl-6">
                  <div className="xl-12 flex">
                    <h3 className="font-prugray no-padding no-margin flex f-center">Transaction type:</h3> &nbsp;
                  <select className="select-no-effect font-prulife bg-none border-bottom h3">
                      <option className="hidden font-prugray">Reinstatement</option>
                      <option className="item font-prugray">Reinstatement</option>
                    </select>
                    <select className="select-no-effect font-prulife bg-none border-bottom h3">
                      <option className="hidden font-prugray">Type</option>
                      <option className="item font-prugray">Reinstatement</option>
                    </select>
                  </div>
                </div>
                <div className="xl-6 margin-auto">
                  <h3 className="font-prugrayno-margin f-end flex font-prulife">Transaction No: {this.props.policy.appNo}
