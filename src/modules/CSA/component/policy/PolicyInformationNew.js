  ...
  render() {
    ...
    return (
      <div className="xl-12 flex-container flex-wrap">
        ...
        <Input editable="false" inputLabel="Plan Status:" inputPlaceholder="Lapsed" txtboxClass="no-border" inputClass="col xl-3 input-container" value={policy.policyStatus}/>
