      ...
      <Fragment>
        ...
        {this.props.type === "approver" &&
          <div className="xl-12 flex-container flex-wrap insured-details">
            ...
            <Input editable="false" inputLabel="Plan Status:" inputPlaceholder="Lapsed" txtboxClass="no-border" inputClass="col xl-6 input-container" value={policy.premiumStatus} />
            <Input editable="false" inputLabel="Premium Status:" inputPlaceholder="Premium Paying" txtboxClass="no-border" inputClass="col xl-6 input-container" value={policy.premiumStatus} />
            ...
            <Input editable="false" inputLabel="First Issue Date:" inputPlaceholder="mm/dd/yyyy" txtboxClass="no-border" inputClass="col xl-6 input-container" value={policy.firstIssueDate} />
            <Input editable="false" inputLabel="Risk Commencement Date:" inputPlaceholder="mm/dd/yyyy" txtboxClass="no-border" inputClass="col xl-6 input-container" value={policy.riskCommencementDate} />

            <Input editable="false" inputLabel="Currency:" inputPlaceholder="PHP" txtboxClass="no-border" inputClass="col xl-6 input-container" value={policy.currency} />
