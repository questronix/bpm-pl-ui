  ...
  render() {
    return (
      <div className="xl-12 flex-container flex-wrap">
        <Input editable="false" inputLabel="Agent Name:" inputPlaceholder="First name Last name" txtboxClass="no-border" inputClass="col xl-8 input-container"value={this.props.policy.agentLastName + ", " + this.props.policy.agentFirstName + " " + this.props.policy.agentMiddleName}/>
