  ...
  render() {
    return (
      <div className="xl-12 flex-container flex-wrap">
        <Input inputLabel="Agent Name:" inputPlaceholder="First name Last name" txtboxClass="no-border" inputClass="col xl-8 input-container"value={this.props.policy.agentLastName + ", " + this.props.policy.agentFirstName + this.props.policy.agentMiddleName}/>
        ...
        <Input inputLabel="Agent Status:" inputPlaceholder="Status" txtboxClass="no-border" inputClass="col xl-4 input-container" value={this.props.policy.agentStatus} />
      </div>
