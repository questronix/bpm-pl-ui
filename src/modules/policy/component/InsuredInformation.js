            ...
            <div className="card col xl-12 l-12 m-12 s-12 xs-12 no-padding">
              ...
              <div className="card-body flex-container flex-wrap">
                <div className="col xl-12 l-12 m-12 s-12 xs-12 flex-container flex-wrap">
                  <div className="xl-6 l-6 m-6 s-12 xs-12 f-justify-space-between flex f-center  m-f-center s-f-center xs-f-center f-justify-space-between">
                  ...
                  <div className="xl-6 l-6 m-6 s-12 xs-12 f-justify-space-between flex f-center  m-f-center s-f-center xs-f-center f-justify-space-between">
                    ...
                    <input className="col xl-6 l-6 m-6 s-6 xs-6 input disabled" type="text" defaultValue={insured.clientId} disabled />
                  </div>
                  <div className="xl-6 l-6 m-6 s-12 xs-12 f-justify-space-between flex f-center  m-f-center s-f-center xs-f-center f-justify-space-between">
                  ...
                  <div className="xl-6 l-6 m-6 s-12 xs-12 f-justify-space-between flex f-center  m-f-center s-f-center xs-f-center f-justify-space-between">
                    ...
                    <input className="col xl-6 l-6 m-6 s-6 xs-6 input disabled" type="text" defaultValue={insured.middleName} disabled />
                  </div>
                  <div className="xl-6 l-6 m-6 s-12 xs-12 f-justify-space-between flex f-center  m-f-center s-f-center xs-f-center f-justify-space-between">
