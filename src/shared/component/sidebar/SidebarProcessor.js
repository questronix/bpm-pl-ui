...
class SidebarProcessor extends Component {
  constructor(props) {
    super(props);
    this.state = {
      sideTabs: 0
    ...
    return (
      <div className="sidebar col no-padding xl-2 l-2 m-3 s-3 xs-4 ">
        ...
        <div className="sidebar-body">
          <ul>
            <NavLink to="/list" className="flex f-start f-center" activeClassName="active flex f-start f-center" accessKey="1">
              <li>
            ...
            <NavLink to="/processor" className="flex f-start f-center" activeClassName="active flex f-start f-center" accessKey="2">
              <li>
...
export default SidebarProcessor;